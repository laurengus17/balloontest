<GlobalFunctions>
  ...
  <Folder id="API_Helpers">
    ...
    />
    <State id="updatedRow" value="" />
    <State id="tradeId" />
    <State id="certificateFileName" />
    <State id="licenseFileName" />
    <State id="certificateFileIdAfterUpload" />
    <State id="licenseFileIdAfterUpload" />
    <Function
      id="addSubtradesPayloadTransformer"
      funcBody={include("./lib/addSubtradesPayloadTransformer.js", "string")}
    />
    <State id="certificatePutUrl" />
    <State id="licensePutUrl" />
    <JavascriptQuery
    ...
    <JavascriptQuery
      ...
      showSuccessToaster={false}
    />
    <State id="directApproveTradeStatus" value="null" />
    <JavascriptQuery
  ...
  <JavascriptQuery
    ...
    showSuccessToaster={false}
  />
  <State id="subtradeBeingRejected" />
  <State id="subtradeIdsOfTrade" />
  <State id="isAlertVisible" value="false" />
  <JavascriptQuery
    id="query11"
    notificationDuration={4.5}
